	...
	async function handleSubmit(event) {
		...
		try {			
			...
			if (response.status === 'ok') {
				...
				goto('/login?message=Account created successfully. Please login.');
			} else {
...
<div class="min-h-screen auth-bg flex items-center justify-center p-4">
	<div class="w-full max-w-4xl">
		<div class="auth-card rounded-3xl shadow-2xl overflow-hidden">
			<div class="flex flex-col lg:flex-row-reverse lg:min-h-[700px]">
				
				<!-- Right Panel - Welcome Message -->
				<div class="lg:w-1/2 p-6 sm:p-8 md:p-10 lg:p-12 flex flex-col justify-center items-center text-white relative overflow-hidden order-first lg:order-last" style="background-color: #7495ED;">
					<!-- Decorative elements (hidden on small screens) -->
					<div class="hidden sm:block absolute top-0 right-0 w-40 h-40 bg-white opacity-10 rounded-full translate-x-20 -translate-y-20"></div>
					<div class="hidden sm:block absolute bottom-0 left-0 w-32 h-32 bg-white opacity-10 rounded-full -translate-x-16 translate-y-16"></div>
					
					<div class="relative z-10 text-center">
						<h2 class="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4">Welcome Back!</h2>
						<p class="text-base sm:text-lg mb-8 opacity-90 leading-relaxed">
							To keep connected with us please login with your personal info
						</p>
						<div class="space-y-4">
							<p class="text-lg opacity-80">Already have an account?</p>
							<a href="/login" 
							...
							<div class="flex items-start">
								...
								<div class="ml-3 text-sm">
									<label for="agree-terms" class="text-gray-600">
										I agree to the
										<a href="#" class="text-primary hover:text-primary-dark font-medium">Terms and Conditions</a>
										and
						...
						<div class="mt-8">
							<div class="relative">
								...
								<div class="relative flex justify-center text-sm">
									<span class="px-2 bg-white text-gray-500">or register with social platforms</span>
								</div>
							</div>
